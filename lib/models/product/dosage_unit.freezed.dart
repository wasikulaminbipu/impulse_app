...
bool operator ==(Object other) {
  final _this = this as DosageUnit;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DosageUnit&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.nameEn, _this.nameEn) || other.nameEn == _this.nameEn)&&(identical(other.nameBn, _this.nameBn) || other.nameBn == _this.nameBn));
}
...
String toString() {
  final _this = this as DosageUnit;
  return 'DosageUnit(id: ${_this.id}, nameEn: ${_this.nameEn}, nameBn: ${_this.nameBn})';
}
