...
bool operator ==(Object other) {
  final _this = this as Composition;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Composition&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.productId, _this.productId) || other.productId == _this.productId)&&(identical(other.ingredientEn, _this.ingredientEn) || other.ingredientEn == _this.ingredientEn)&&(identical(other.ingredientBn, _this.ingredientBn) || other.ingredientBn == _this.ingredientBn)&&(identical(other.concentration, _this.concentration) || other.concentration == _this.concentration)&&(identical(other.displayOrder, _this.displayOrder) || other.displayOrder == _this.displayOrder));
}
...
int get hashCode {
  final _this = this as Composition;
  return Object.hash(runtimeType,_this.id,_this.productId,_this.ingredientEn,_this.ingredientBn,_this.concentration,_this.displayOrder);
}

@override
String toString() {
  final _this = this as Composition;
  return 'Composition(id: ${_this.id}, productId: ${_this.productId}, ingredientEn: ${_this.ingredientEn}, ingredientBn: ${_this.ingredientBn}, concentration: ${_this.concentration}, displayOrder: ${_this.displayOrder})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,productId,ingredientEn,ingredientBn,concentration,displayOrder);
}
