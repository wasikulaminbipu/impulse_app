...
String toString() {
  final _this = this as TargetGroup;
  return 'TargetGroup(id: ${_this.id}, nameEn: ${_this.nameEn}, nameBn: ${_this.nameBn}, iconName: ${_this.iconName})';
}
