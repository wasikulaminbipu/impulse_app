...
Widget createManufacturersScreenHarness({required ProviderContainer container}) {
...
void main() {
  testWidgets('ManufacturersScreen displays title and empty state when list is empty', (tester) async {
    ...
    await tester.pumpWidget(createManufacturersScreenHarness(container: container));
  ...
  testWidgets('ManufacturersScreen displays manufacturer cards when data is available', (tester) async {
    final sampleManufacturer = Manufacturer(
      id: 1,
