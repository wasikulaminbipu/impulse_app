...
void main() {
  group('In-Memory DAO Unit Tests', () {
    ...
    test('LocationDao handles Base and Upazila assignment', () async {
      ...
      await distDb.executor.customExecute("INSERT INTO regions (id, name_en, name_bn) VALUES (1, 'Dhaka', 'ঢাকা');");
      await distDb.executor.customExecute("INSERT INTO areas (id, region_id, name_en, name_bn) VALUES (10, 1, 'Gazipur Area', 'গাজীপুর এলাকা');");
      await distDb.executor.customExecute("INSERT INTO divisions (id, name_en, name_bn) VALUES (1, 'Dhaka', 'ঢাকা');");
      await distDb.executor.customExecute("INSERT INTO districts (id, division_id, name_en, name_bn) VALUES (1, 1, 'Gazipur', 'গাজীপুর');");
      await distDb.executor.customExecute("INSERT INTO upazilas (id, district_id, name_en, name_bn) VALUES (101, 1, 'Sreepur', 'শ্রীপুর');");
      await distDb.executor.customExecute("INSERT INTO upazilas (id, district_id, name_en, name_bn) VALUES (102, 1, 'Kaliakair', 'কালিয়াকৈর');");

      final base = const Base(id: 1, areaId: 10, nameEn: 'Sreepur Base', nameBn: 'শ্রীপুর বেস');
      ...
      expect(basesWithUpazilas.first.upazilas.map((u) => u.id), containsAll([101, 102]));
